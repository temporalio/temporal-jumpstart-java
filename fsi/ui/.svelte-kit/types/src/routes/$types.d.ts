...
type LayoutRouteId = RouteId | "/" | "/membership/[user_id]" | "/registrations/[id]" | "/wealthmanagement" | "/wealthmanagement/application" | null
type LayoutParams = RouteParams & { user_id?: string; id?: string }
