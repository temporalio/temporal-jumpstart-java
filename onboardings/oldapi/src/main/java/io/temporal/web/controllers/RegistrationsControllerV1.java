package io.temporal.web.controllers;
...
import io.temporal.web.rest.messages.RegistrationsPutV1;
...
public class RegistrationsControllerV1 {
    ...
    ResponseEntity<String> registrationsPut(
            @PathVariable String id, @RequestBody RegistrationsPutV1 params ) {
        ...
        try {
            var run = WorkflowClient.executeUpdateWithStart(workflowStub::execute, wfArgs);
